...
const Teachers = () => {
  return (
    <main className="pt-20">
      <div className="teachers-banner py-40">
        <h1 className="text-center text-primary text-5xl font-bold">Our Teachers</h1>
      </div>
          ...
          <Card color="transparent" shadow={false} className="w-full ">
            ...
            >
              ...
              <div className="flex w-full flex-col gap-0.5">
                ...
                <Typography color="blue-gray">Sr. Web Developer</Typography>
              </div>
            </CardHeader>
